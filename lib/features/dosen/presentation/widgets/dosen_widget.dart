...
// ─────────────────────────────────────────────────────────
// ModernDosenCard — Card modern dengan gradient & animasi
// ─────────────────────────────────────────────────────────
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 4),
                      // Alamat (street + city dari AddressModel)
                      _buildInfoRow(
...
// ─────────────────────────────────────────────────────────
// DosenCard — Card simple (versi alternatif dari modul)
// ─────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────
// DosenListView — ListView wrapper yang dipakai di dosen_page
// ─────────────────────────────────────────────────────────
